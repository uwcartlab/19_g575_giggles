...
L.Control.FuseSearch = L.Control.extend({
    ...
    createResultItem: function(props, container) {
        ...
        if((resultItem = resultsMap.get(props.Nation_Cor)) != undefined) {
            ...
            combinedPropsMap.get(props.Nation_Cor).push(props.layer);
        }else{
            ...
            combinedPropsMap.set(props.Nation_Cor, [props.layer]);
        }
        ...
        resultItem.onclick = function() {
            ...
            console.log(combinedPropsMap.get(props.Nation_Cor));
            for(var layer in combinedPropsMap.get(props.Nation_Cor)){
                console.log(layer);
                /*layer.setStyle({
                //weight: 5,
                fillColor: '#DC143C',
